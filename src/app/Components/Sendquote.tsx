...
const SendQuoteSection = () => {
    return (
      <div className="w-[1180px] h-[420px] relative rounded-md">
        ...
        <div className="absolute top-1/2 right-4 transform -translate-y-1/2 w-[50%] bg-white p-6 rounded-md shadow-lg">
          {/* Heading */}
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Send Quote to Suppliers</h2>
  
          {/* Form Fields */}
          <div className="space-y-4">
            {/* Item Input */}
            <div>
              <label htmlFor="item" className="text-sm text-gray-700">What item do you need?</label>
              <input
                type="text"
                id="item"
